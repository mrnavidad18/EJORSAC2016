    ...
    public class FacturaDAO
    {
        ...
        public List<Factura> BuscarPorCliente(int idCliente)
        {
            try
            {
                ...
                string query = "SP_TBL_FACTURA_BUSCAR_X_CLIENTE";
                SqlParameter[] param = new SqlParameter[]
                {
                      DBHelper.MakeParam("@P_ID_CLIENTE",idCliente)
                };
        ...
        public List<Factura> BuscarPorFechas(DateTime fechaDe, DateTime fechaHasta)
        {
            try
            {
                List<Factura> lista = null;
                ...
                string query = "SP_TBL_FACTURA_BUSCAR_X_FECHAS";
                SqlParameter[] param = new SqlParameter[]
                {
                      DBHelper.MakeParam("@P_FECHA_DE",fechaDe),
                      DBHelper.MakeParam("@P_FECHA_HASTA",fechaHasta)
                };
