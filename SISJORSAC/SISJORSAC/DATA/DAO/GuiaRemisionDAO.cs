    ...
    public class GuiaRemisionDAO
    {
        ...
        public Object[] Agregar(GuiaRemision guiaRemision)
        {
            ...
            try
            {
                ...
                SqlParameter[] dbParams = new SqlParameter[]
             {
                 ...
                 DBHelper.MakeParam("@P_PTO_PARTIDA",guiaRemision.PTO_PARTIDA.ToUpper()),  
                 DBHelper.MakeParam("@P_PTO_LLEGADA",guiaRemision.PTO_LLEGADA.ToUpper()), 
                 DBHelper.MakeParam("@P_COD_CLIE",guiaRemision.cliente.COD_CLI),
                 DBHelper.MakeParam("@P_VEHICULO_MARCA",guiaRemision.VEHICULO_MARCA.ToUpper()),
                 DBHelper.MakeParam("@P_NRO_CERTIFICADO",guiaRemision.NRO_CERTIFICADO.Trim()),
                 DBHelper.MakeParam("@P_NOMBRE_CONDUCTOR",guiaRemision.NONBRE_CONDUCTOR.ToUpper()),
                 DBHelper.MakeParam("@P_NRO_BREVETE",guiaRemision.NRO_BREVETE.Trim().ToUpper()),
                 DBHelper.MakeParam("@P_NOMB_TRANSPORTE",guiaRemision.NOMB_TRANSPORTE.ToUpper()),
                 DBHelper.MakeParam("@P_RUC_TRANSPORTE",guiaRemision.RUC_TRANSPORTE.Trim()),
                 DBHelper.MakeParam("@P_TIPO_COMPROB",guiaRemision.TIPO_COMPROB.ToUpper()),
                 DBHelper.MakeParam("@P_TIPO_TRASLADO",guiaRemision.TIPO_TRASLADO.ToUpper()),
                 DBHelper.MakeParam("@P_MTO_TRASLADO",guiaRemision.MTO_TRASLADO.ToUpper()),
                 DBHelper.MakeParam("@P_PROVINCIA",guiaRemision.PROVINCIA.ToUpper()),
                 DBHelper.MakeParam("@P_DEPARTAMENTO",guiaRemision.DEPARTAMENTO.ToUpper()),
                 DBHelper.MakeParam("@P_DISTRITO",guiaRemision.DISTRITO.ToUpper()),
                 DBHelper.MakeParam("@P_SITUACION",guiaRemision.SITUACION.ToUpper()),
        ...
        public Object[] AgregarConNroGuia(GuiaRemision guiaRemision)
        {
            ...
            try
            {
                ...
                SqlParameter[] dbParams = new SqlParameter[]
             {
                 DBHelper.MakeParam("@P_NRO_GUIA",guiaRemision.FECHA_EMISION),
                 DBHelper.MakeParam("@P_FECHA_EMISION",guiaRemision.FECHA_EMISION),
                 DBHelper.MakeParam("@P_PTO_PARTIDA",guiaRemision.PTO_PARTIDA.ToUpper()),  
                 DBHelper.MakeParam("@P_PTO_LLEGADA",guiaRemision.PTO_LLEGADA.ToUpper()), 
                 DBHelper.MakeParam("@P_COD_CLIE",guiaRemision.cliente.COD_CLI),
                 DBHelper.MakeParam("@P_VEHICULO_MARCA",guiaRemision.VEHICULO_MARCA.ToUpper()),
                 DBHelper.MakeParam("@P_NRO_CERTIFICADO",guiaRemision.NRO_CERTIFICADO.ToUpper()),
                 DBHelper.MakeParam("@P_NOMBRE_CONDUCTOR",guiaRemision.NONBRE_CONDUCTOR.ToUpper()),
                 DBHelper.MakeParam("@P_NRO_BREVETE",guiaRemision.NRO_BREVETE.ToUpper().Trim()),
                 DBHelper.MakeParam("@P_NOMB_TRANSPORTE",guiaRemision.NOMB_TRANSPORTE.ToUpper()),
                 DBHelper.MakeParam("@P_RUC_TRANSPORTE",guiaRemision.RUC_TRANSPORTE.Trim()),
                 DBHelper.MakeParam("@P_TIPO_COMPROB",guiaRemision.TIPO_COMPROB.ToUpper()),
                 DBHelper.MakeParam("@P_TIPO_TRASLADO",guiaRemision.TIPO_TRASLADO.ToUpper()),
