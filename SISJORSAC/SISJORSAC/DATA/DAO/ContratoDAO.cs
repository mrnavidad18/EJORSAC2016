        ...
        public Object[] Agregar(Contrato contrato)
        {
            ...
            try
            {
                ...
                SqlParameter[] dbParams = new SqlParameter[]
             {
                 ...
                 DBHelper.MakeParam("@P_DIRECCION_OBRA",contrato.DIRECCION_OBRA.ToUpper()),
                 DBHelper.MakeParam("@P_TRANSPORTE",contrato.TRANSPORTE.ToUpper()),
                 ...
                 DBHelper.MakeParam("@P_MONEDA",contrato.MONEDA.ToUpper()),
                 DBHelper.MakeParam("@P_GARANTIA",contrato.GARANTIA),
                 DBHelper.MakeParam("@P_CHEQUE",contrato.CHEQUE),
                 DBHelper.MakeParam("@P_DOCUMENTO",contrato.DOCUMENTO.ToUpper()),
